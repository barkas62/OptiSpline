...
/* Functions */
	...
	typedef BOOL (CALLBACK * WTENUMPROC)(HCTX, LPARAM);
	typedef BOOL (CALLBACK * WTCONFIGPROC)(HCTX, HWND);
	typedef LRESULT (CALLBACK * WTHOOKPROC)(int, WPARAM, LPARAM);
...
/* Win32 replacements for non-portable functions. */
	#ifndef NOWTQUEUEFXNS
	/* ADVANCED PACKE AND QUEUE FUNCTIONS */
